...
px.line(expl2, x='begindatum', y='tellen')


# In[12]:


test = pd.DataFrame(expl['zaak_categorie'].value_counts().reset_index())
test.columns = ['zaak_categorie', 'count']


# In[13]:


fig2 = px.bar(test, x='zaak_categorie', y = 'count', text_auto='.2s', 
...
overlast2 = overlast.merge(stadsdelen, on='stadsdeel')
